export const data = [
  ...
  },
  {
    ...
    text: [
      ...
      "Smoking is prohibited inside Logic Rent A Car Vehicles and offenders will be charged AED300/- against violating the same.",
      "Hirer must inform Logic Rent A Car of his intention to return the vehicle at another premise or other Emirate, and must define the date and time otherwise excess days would be charged to him.",
  ...
  },
  {
    ...
    text: [
      "Debit cards & Credit Cards are accepted by Logic Rent A Car as a mean of payment.",
  ...
  },
  {
    ...
    text: [
      "Smoking is prohibited inside Logic Rent A Car vehicles and offenders are responsible to pay a penalty charge of Dhs300/- to LOGIC RENT A CAR against violating the same.",
    ],
  },
  {
    heading: "19. Usage of Vehicle/s:-",
    text: [
      "Hirer commits that he won't allow anybody to drive the rented vehicle unless been authorized By LOGIC RENT A CAR..",
      "Hirer undertakes that neither he nor any of the listed additional drivers will use the vehicle in, Pushing, Pulling or Towing objects, Races & Fun Drive, Rough Roads & desert Safaris, Teach Driving, Rent the vehicle without LOGIC RENT A CAR permission.",
      ...
      "Hirer commits that he/any additional driver will not drive the vehicle outside UAE except to OMAN subject to a pre-approval from Logic Rent A Car. Hirer commits that he or any additional driver will not use the vehicle to transport commercial passengers or any materials/products that are prohibited by the UAE Laws.",
    ],
  },
  {
    heading: "20. Vehicle Check-out & Check-in: -",
    text: [
      "Logic Rent A Car will conduct vehicle's check-out & check–in at the time of handing it over or receiving it, to ensure vehicle's condition and to mark the status of each rented vehicle.",
    ],
  },
  {
    ...
    text: [
      ...
      "2. If you return the Vehicle before its Return-due date and time, then the Rental Period will be ended on the day & time of the handover of the Vehicle keys to LOGIC RENT A CAR counter.",
      "b- Late Return: -",
      ...
      "Then you will be recorded in Logic Rent A Car blacklisted customer's file and won't be able to receive any future service from Logic Rent A Car worldwide.",
    ],
  },
  {
    heading: "22. Grace Period of a Rental:",
    text: [
      "Logic Rent A Car offers you 59 minutes as a grace period after the 24 hours/day, then extra minutes / hours will be rounded up to a whole rental day/s.",
      "Rental Day = 24 hours.",
      "Rental Week = 7 days.",
