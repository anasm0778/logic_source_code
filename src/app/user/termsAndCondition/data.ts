export const data = [
  ...
  },
  {
    ...
    text: [
      "Smoking is prohibited inside Europcar vehicles and offenders are responsible to pay a penalty charge of Dhs300/- to LOGIC RENT A CAR against violating the same.",
    ],
  },
  {
